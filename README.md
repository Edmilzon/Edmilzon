...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Inter&weight=500&size=24&pause=1000&color=6366F1&center=true&vCenter=true&width=480&lines=Backend+%26+DevOps+Engineer;Arquitecto+de+soluciones;NestJS+%C2%B7+Spring+Boot+%C2%B7+TypeScript;C%C3%B3digo+que+transforma+ideas" alt="Typing SVG" />
</p>
...
Backend & DevOps Engineer de **Cochabamba, Bolivia**. Estudiante de **Ingeniería en Sistemas** en la **Universidad Mayor de San Simón (UMSS)**.

Transformo ideas en soluciones escalables. Mi stack fuerte: **NestJS**, **Spring Boot**, **TypeScript**, **PostgreSQL**, **Docker** y **AWS**. También desarrollo móvil con **Flutter** y frontend con **Next.js**.

Apasionado por la **arquitectura de software** (hexagonal, DDD, clean architecture, SOLID). Experto en **Linux** (Arch Linux) y **DevOps** con despliegues en AWS, Vercel, Railway y Render.
...
### Sistema Becas UMSS
> Plataforma de calificación para docentes. Carga de estudiantes por CSV, autenticación de docentes y administración de convocatorias.
...
### Eco Bocado (FoodSave)
> App contra el desperdicio de alimentos. Conecta restaurantes con comida sobrante a clientes que la compran con descuento. Mapas con coordenadas reales.
...
### Plataforma Cursos
> Plataforma educativa con roles (estudiante, profesor, admin), gamificación, progreso y cursos de diversos temas.
...
> App web de venta de mermeladas artesanales con autenticación, catálogo, carrito de compras y gestión de ventas con QR y efectivo.
...
> Plataforma de alquiler de vehículos con búsqueda, reservas y múltiples servicios de calificación integrados.
...
### EmotionDetect
> Chatbot que detecta emociones en texto usando K-means, TF-IDF y aprendizaje no supervisado.
...
|---|---|---|
| [user_blog_backend](https://github.com/Edmilzon/user_blog_backend) | ![Spring Boot](https://img.shields.io/badge/Spring_Boot-6DB33F?style=flat-square&logo=spring-boot&logoColor=white) + JPA + ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4169E1?style=flat-square&logo=postgresql&logoColor=white) | API REST con 4 entidades relacionadas |
| [oh_Sansi_backend](https://github.com/Edmilzon/oh_Sansi_backend) | ![PHP](https://img.shields.io/badge/PHP-777BB4?style=flat-square&logo=php&logoColor=white) + ![Laravel](https://img.shields.io/badge/Laravel-FF2D20?style=flat-square&logo=laravel&logoColor=white) | Gestor de olimpiadas y medallas |
| [Calculadora flujos efectivo](https://github.com/Edmilzon/Calculadora_flujos_efectivo_astro) | ![Astro](https://img.shields.io/badge/Astro-BC52EE?style=flat-square&logo=astro&logoColor=white) + ![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white) | Gestión contable |
| [Tres en Raya IA](https://github.com/Edmilzon/Tres_en_Raya_Proyct_IA) | ![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) | IA con Minimax + BFS |
| [PetFinder](https://github.com/Edmilzon/search_web) | ![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) + SPARQL | Buscador semántico de mascotas |
| [proyect_mercado](https://github.com/Edmilzon/proyect_mercado_backend) | ![NestJS](https://img.shields.io/badge/NestJS-E0234E?style=flat-square&logo=nestjs&logoColor=white) + ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4169E1?style=flat-square&logo=postgresql&logoColor=white) | E-commerce multi-usuario |
| [Plataforma Python](https://github.com/Edmilzon/plataforma_educatica_python) | ![Next.js](https://img.shields.io/badge/Next.js-000000?style=flat-square&logo=next.js&logoColor=white) + ![NestJS](https://img.shields.io/badge/NestJS-E0234E?style=flat-square&logo=nestjs&logoColor=white) | Curso interactivo de Python |
| [loginRegister-backend](https://github.com/Edmilzon/loginRegister-backend) | ![Spring Boot](https://img.shields.io/badge/Spring_Boot-6DB33F?style=flat-square&logo=spring-boot&logoColor=white) | Auth con JWT |
| [loginRegister-backend-nestjs](https://github.com/Edmilzon/loginRegister-backend-nestjs) | ![NestJS](https://img.shields.io/badge/NestJS-E0234E?style=flat-square&logo=nestjs&logoColor=white) | Auth con JWT |
| [pizarra_digital](https://github.com/Edmilzon/pizarra_digital) | APK Android | Pizarra para tablet |
| [Control_voz_gesto_java](https://github.com/Edmilzon/Control_voz_gesto_java) | ![Java](https://img.shields.io/badge/Java-ED8B00?style=flat-square&logo=openjdk&logoColor=white) + ![OpenCV](https://img.shields.io/badge/OpenCV-5C3EE8?style=flat-square&logo=opencv&logoColor=white) | Control por voz y gestos |
| [Detectar_videos_imagen_java](https://github.com/Edmilzon/Detectar_videos_imagen_java) | ![Java](https://img.shields.io/badge/Java-ED8B00?style=flat-square&logo=openjdk&logoColor=white) + ![OpenCV](https://img.shields.io/badge/OpenCV-5C3EE8?style=flat-square&logo=opencv&logoColor=white) | Visión por computadora |

<hr />

## Experiencia Freelance

| Proyecto | Rol | Stack | Duración |
|---|---|---|---|
| Sistema Becas UMSS (PBI) | Full Stack Developer | ![NestJS](https://img.shields.io/badge/NestJS-E0234E?style=flat-square&logo=nestjs&logoColor=white) · ![Next.js](https://img.shields.io/badge/Next.js-000000?style=flat-square&logo=next.js&logoColor=white) · ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4169E1?style=flat-square&logo=postgresql&logoColor=white) | 1 año |
| Plataforma Cursos | Full Stack Developer | ![Next.js](https://img.shields.io/badge/Next.js-000000?style=flat-square&logo=next.js&logoColor=white) · ![NestJS](https://img.shields.io/badge/NestJS-E0234E?style=flat-square&logo=nestjs&logoColor=white) · ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4169E1?style=flat-square&logo=postgresql&logoColor=white) | ~8 meses |
| searchCar (Alquiler Autos) | Full Stack Developer | ![Next.js](https://img.shields.io/badge/Next.js-000000?style=flat-square&logo=next.js&logoColor=white) · ![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white) | ~6 meses |
| Curso Aprendizaje Python | Developer / Instructor | ![Next.js](https://img.shields.io/badge/Next.js-000000?style=flat-square&logo=next.js&logoColor=white) · ![NestJS](https://img.shields.io/badge/NestJS-E0234E?style=flat-square&logo=nestjs&logoColor=white) · ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4169E1?style=flat-square&logo=postgresql&logoColor=white) | ~6 meses |
| proyect_mercado (E-commerce) | Full Stack Developer | ![NestJS](https://img.shields.io/badge/NestJS-E0234E?style=flat-square&logo=nestjs&logoColor=white) · ![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white) · ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4169E1?style=flat-square&logo=postgresql&logoColor=white) | ~5 meses |
| admi-ventas (Mermeladas) | Full Stack Developer | ![Next.js](https://img.shields.io/badge/Next.js-000000?style=flat-square&logo=next.js&logoColor=white) · ![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white) · ![Tailwind CSS](https://img.shields.io/badge/Tailwind_CSS-06B6D4?style=flat-square&logo=tailwind-css&logoColor=white) | ~4 meses |
| oh_Sansi (Olimpiadas) | Backend Developer | ![PHP](https://img.shields.io/badge/PHP-777BB4?style=flat-square&logo=php&logoColor=white) · ![Laravel](https://img.shields.io/badge/Laravel-FF2D20?style=flat-square&logo=laravel&logoColor=white) | ~3 meses |
| Eco Bocado (FoodSave) | Mobile + Backend | ![Flutter](https://img.shields.io/badge/Flutter-02569B?style=flat-square&logo=flutter&logoColor=white) · ![NestJS](https://img.shields.io/badge/NestJS-E0234E?style=flat-square&logo=nestjs&logoColor=white) · ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4169E1?style=flat-square&logo=postgresql&logoColor=white) | En desarrollo |
...
| **Arquitectura** | Hexagonal, DDD, Clean Architecture, SOLID, Patrones GoF |
| **Herramientas** | ![Git](https://img.shields.io/badge/Git-F05032?style=flat-square&logo=git&logoColor=white) ![GitHub](https://img.shields.io/badge/GitHub-181717?style=flat-square&logo=github&logoColor=white) ![OpenCV](https://img.shields.io/badge/OpenCV-5C3EE8?style=flat-square&logo=opencv&logoColor=white) |
| **Aprendiendo** | ![Kotlin](https://img.shields.io/badge/Kotlin-7F52FF?style=flat-square&logo=kotlin&logoColor=white) ![C#](https://img.shields.io/badge/C%23-512BD4?style=flat-square&logo=csharp&logoColor=white) ![Go](https://img.shields.io/badge/Go-00ADD8?style=flat-square&logo=go&logoColor=white) ![Rust](https://img.shields.io/badge/Rust-000000?style=flat-square&logo=rust&logoColor=white) ![Kubernetes](https://img.shields.io/badge/Kubernetes-326CE5?style=flat-square&logo=kubernetes&logoColor=white) |
...
<p align="center">
  <strong>Código que transforma ideas en soluciones</strong>
</p>
